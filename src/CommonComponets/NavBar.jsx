      ...
      >
        ...
        <div className="flex gap-4">
          ...
          <button onClick={() => navigateToLogin()}>
            {
              image ? <img src={image} className="h-6 rounded-full" referrerpolicy="no-referrer"/> : <button className="bg-blue-700 text-white px-2  py-1 text-sm rounded-md"> Login</button>
